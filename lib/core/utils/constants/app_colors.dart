...
class AppColors {
  ...
  static const Color customGray = Color(0xFFEAEAEA);
  static const Color colorBack = Colors.black;
  static const Color customGreen = Color(0xFF429F42);
  static const Color coralRed = Color(0xFFFF3B3B);
  static const Color customBlue = Color(0xFF2F2FFF);
  static const Color customPink = Color(0xFFFFD9D9);
  static const Color opacityGreen = Color(0xFFD9ECD9);
